...
@implementation UIDevice (BZMReactor)

- (BOOL)bzm_isJailBreaked {
...
- (NSString *)bzm_uuid {
    if (sUuid.length == 0) {
        ...
        NSString *accessGroup = BZMStrWithFmt(@"%@.shared", [UIApplication sharedApplication].bzm_teamID);
